...
function encodeToRot13(str) {
    var newStr = "";
    var startStr = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
    var endStr =   "nopqrstuvwxyzabcdefghijklmNOPQRSTUVWXYZABCDEFGHIJKLM";
    for(var i in str)
    {
      var index = startStr.indexOf(str[i]);
      if(index == -1)
      {
        newStr = newStr + str[i];
      }
      else {
          newStr = newStr + "" + endStr[index];
      }
    }
    return newStr;
}
